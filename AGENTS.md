...
This project is indexed by GitNexus as **FeedMaker** (6126 symbols, 12342 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
