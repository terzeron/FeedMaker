...
This project is indexed by GitNexus as **FeedMaker** (7661 symbols, 17194 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
