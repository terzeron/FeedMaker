...
This project is indexed by GitNexus as **FeedMaker** (6210 symbols, 11720 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
