...
@app.delete("/groups/{group_name}/site_config")
async def delete_site_config(group_name: str, request: Request):
...
@app.get("/groups/{group_name}/feeds/{feed_name]/htmls/{html_file_name}")
