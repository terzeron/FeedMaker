...
class TestUpdateMangaSite(unittest.TestCase):
    ...
    def test_update_domain_success(self):
        ...
        site_config: dict[str, Any] = {"url": "https://example.com123/test", "referer": "https://example.com123/referer"}
        with open(self.site_config_path, "w", encoding="utf-8") as f:
            json.dump(site_config, f)

        # Create test feed config
        feed_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/list1", "https://example.com123/list2"]}}}
        ...
        with open(self.conf_file_path, "r", encoding="utf-8") as f:
            ...
            expected_urls = ["https://example.com456/list1", "https://example.com456/list2"]
    ...
    def test_update_domain_test_run(self):
        ...
        # Create test feed config
        feed_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/list1"]}}}
        with open(self.conf_file_path, "w", encoding="utf-8") as f:
            json.dump(feed_config, f)
    ...
    def test_update_domain_feed_without_list_url_list(self):
        ...
        feed_config: dict[str, Any] = {"configuration": {"collection": {}}}
        with open(self.conf_file_path, "w", encoding="utf-8") as f:
            json.dump(feed_config, f)
    ...
    def test_update_domain_feed_without_collection(self):
        ...
        feed_config: dict[str, Any] = {"configuration": {}}
        with open(self.conf_file_path, "w", encoding="utf-8") as f:
            json.dump(feed_config, f)
    ...
    def test_update_domain_multiple_feeds(self):
        ...
        feed1_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/feed1/list1"]}}}
        ...
        feed2_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/feed2/list1"]}}}
        ...
        feed3_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/feed3/list1"]}}}
        ...
        with open(feed1_conf, "r", encoding="utf-8") as f:
            ...
            self.assertEqual(updated_feed1_config["configuration"]["collection"]["list_url_list"], ["https://example.com456/feed1/list1"])

        with open(feed2_conf, "r", encoding="utf-8") as f:
            updated_feed2_config = json.load(f)
            self.assertEqual(updated_feed2_config["configuration"]["collection"]["list_url_list"], ["https://example.com456/feed2/list1"])

        with open(feed3_conf, "r", encoding="utf-8") as f:
            updated_feed3_config = json.load(f)
            self.assertEqual(updated_feed3_config["configuration"]["collection"]["list_url_list"], ["https://example.com456/feed3/list1"])
    ...
    def test_update_domain_skip_dot_directories(self):
        ...
        dot_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": ["https://example.com123/hidden/list1"]}}}
        ...
        with open(dot_conf, "r", encoding="utf-8") as f:
            ...
            self.assertEqual(original_dot_config["configuration"]["collection"]["list_url_list"], ["https://example.com123/hidden/list1"])
    ...
    def test_update_domain_url_pattern_matching(self):
        ...
        for original_url, new_number, expected_url in test_cases:
            site_config: dict[str, Any] = {"url": original_url, "referer": "https://example.com123/referer"}
            with open(self.site_config_path, "w", encoding="utf-8") as f:
                json.dump(site_config, f)

            feed_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": [original_url + "/list1"]}}}
            with open(self.conf_file_path, "w", encoding="utf-8") as f:
                json.dump(feed_config, f)
    ...
    def test_update_domain_list_url_pattern_matching(self):
        ...
        for original_url, new_number, expected_url in test_cases:
            ...
            feed_config: dict[str, Any] = {"configuration": {"collection": {"list_url_list": [original_url]}}}
            with open(self.conf_file_path, "w", encoding="utf-8") as f:
                json.dump(feed_config, f)
            ...
            with open(self.conf_file_path, "r", encoding="utf-8") as f:
                updated_feed_config = json.load(f)
                self.assertEqual(updated_feed_config["configuration"]["collection"]["list_url_list"], [expected_url])
