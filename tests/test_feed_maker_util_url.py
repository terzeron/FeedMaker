...
class URLTest(unittest.TestCase):
    def test_get_url_scheme(self) -> None:
        actual = URL.get_url_scheme("http://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "http"
        self.assertEqual(expected, actual)

        actual = URL.get_url_scheme("https://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "https"
        self.assertEqual(expected, actual)

    def test_get_url_domain(self) -> None:
        actual = URL.get_url_domain("http://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "www.naver.com"
        self.assertEqual(expected, actual)

        actual = URL.get_url_domain("https://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "www.naver.com"
        self.assertEqual(expected, actual)
    ...
    def test_get_url_path(self) -> None:
        actual = URL.get_url_path("http://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "/movie/hello/tests.nhn?query=test"
        self.assertEqual(expected, actual)

        actual = URL.get_url_path("https://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "/movie/hello/tests.nhn?query=test"
        self.assertEqual(expected, actual)
    ...
    def test_get_url_prefix(self) -> None:
        ...
        actual = URL.get_url_prefix("http://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "http://www.naver.com/movie/hello/"
        self.assertEqual(expected, actual)

        actual = URL.get_url_prefix("https://www.naver.com/movie/hello/tests.nhn?query=test")
    ...
    def test_get_url_except_query(self) -> None:
        ...
        actual = URL.get_url_except_query("http://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "http://www.naver.com/movie/hello/tests.nhn"
        self.assertEqual(expected, actual)

        actual = URL.get_url_except_query("https://www.naver.com/movie/hello/tests.nhn?query=test")
        expected = "https://www.naver.com/movie/hello/tests.nhn"
        self.assertEqual(expected, actual)
